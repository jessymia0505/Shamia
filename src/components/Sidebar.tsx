...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 bottom-0 left-0 w-80 bg-white border-r border-slate-200 z-50 transform transition-transform duration-300 md:duration-200 ${
      ...
      >
        ...
        {/* Informative micro card on bottom of drawer */}
        <div className="absolute bottom-5 left-5 right-5 p-4 rounded-2xl bg-slate-50 border border-slate-200">
